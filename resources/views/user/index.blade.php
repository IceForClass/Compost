                        ...
                        <div class="mt-8 overflow-x-auto">
                            <div class="inline-block min-w-full py-2 align-middle">
                                <table class="w-full divide-y divide-gray-300">
									...
									<th scope="col" class="py-3 pl-4 pr-3 text-left text-xs font-semibold uppercase tracking-wide text-gray-500">Centre Id</th>
                                    ...
                                    @foreach ($users as $user)
										...
										<td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $user->centre_id }}</td>
